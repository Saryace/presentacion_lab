...
subtitle: "Laboratorio Biofisica de Suelos"
author: ""
...
link entre flujos físicos y biológicos

.footnote[Fuente: [Stępniewski et al.,2002](https://www.sciencedirect.com/science/article/abs/pii/S0167880901002559?via%3Dihub)]
...
dataSHP %>%
  ...
  geom_point(color = "darkgreen", shape=1) +
  labs(title="Curva de conductividad hidráulica",
       subtitle="Datos del paquete {SoilHyP}",
       caption="Ullrich Dettmann") + 
  theme_ipsum() +    
  ylab("Log(K cm/d)") +
...
.x[
* curvas de hidráulicas retención de humedad 
* poco tiempo 
* datos confiables
]
]
...
## ¿Es posible estimar<br>propiedades biofísicas?
